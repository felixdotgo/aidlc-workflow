...
process.stdin.on("end", () => {
  ...
  process.stdout.write(JSON.stringify({ transport: "completed", transcript, usage: { contextChars: prompt.length }, diagnostics: ["legacy wrapper; prefer compiled protocol-v2 driver"] }));
});
